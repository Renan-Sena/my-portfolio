...
function openModal(idx, lang) {
    ...
    if (p.imgPlaceholder && (p.imgPlaceholder.startsWith('assets/') || p.imgPlaceholder.startsWith('http'))) {
        imgArea.innerHTML = `<img src="${p.imgPlaceholder}" alt="${p.name}" class="modal-img" />`;
    } else {
